 ...
 * @author Geoffrey Hing, modified to add functionality
...
function Cluster(leafClusterer) {
  ...
  this.redraw_ = function (isForce) {
    ...
    if (zoom_ >= mz || this.getTotalMarkers() === 1) {
      ...
      if (clusterMarker_ === null) {
        clusterMarker_ = new ClusterMarker_(center_, this, this.getTotalMarkers(), leafClusterer_.getStyles_(), leafClusterer_.getGridSize_() / 2);
