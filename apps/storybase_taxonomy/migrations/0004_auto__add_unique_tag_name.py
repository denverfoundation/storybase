...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'storybase_taxonomy_tag', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Tag', fields ['name']
        db.delete_unique(u'storybase_taxonomy_tag', ['name'])
    ...
    models = {
        ...
        u'storybase_taxonomy.categorytranslation': {
            'Meta': {'unique_together': "(('category', 'language'),)", 'object_name': 'CategoryTranslation'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['storybase_taxonomy.Category']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
