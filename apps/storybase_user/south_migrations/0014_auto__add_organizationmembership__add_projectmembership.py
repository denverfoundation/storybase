...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('storybase_user_organizationmembership', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('member_type', self.gf('django.db.models.fields.CharField')(default='member', max_length=140)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storybase_user.Organization'])),
        ))
        db.send_create_signal('storybase_user', ['OrganizationMembership'])

        # Adding model 'ProjectMembership'
        db.create_table('storybase_user_projectmembership', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('member_type', self.gf('django.db.models.fields.CharField')(default='member', max_length=140)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ...
        db.send_create_signal('storybase_user', ['ProjectMembership'])


    def backwards(self, orm):
        # Deleting model 'OrganizationMembership'
        db.delete_table('storybase_user_organizationmembership')

        # Deleting model 'ProjectMembership'
        db.delete_table('storybase_user_projectmembership')
