...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('storybase_user_project', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'Organization.slug'
        db.add_column('storybase_user_organization', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, default='', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.slug'
        db.delete_column('storybase_user_project', 'slug')

        # Deleting field 'Organization.slug'
        db.delete_column('storybase_user_organization', 'slug')
