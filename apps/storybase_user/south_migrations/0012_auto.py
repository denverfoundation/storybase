...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field featured_assets on 'Project'
        db.create_table('storybase_user_project_featured_assets', (
        ...
        db.create_unique('storybase_user_project_featured_assets', ['project_id', 'asset_id'])

        # Adding M2M table for field featured_assets on 'Organization'
        db.create_table('storybase_user_organization_featured_assets', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('organization', models.ForeignKey(orm['storybase_user.organization'], null=False)),
            ('asset', models.ForeignKey(orm['storybase_asset.asset'], null=False))
        ))
        db.create_unique('storybase_user_organization_featured_assets', ['organization_id', 'asset_id'])


    def backwards(self, orm):
        # Removing M2M table for field featured_assets on 'Project'
        db.delete_table('storybase_user_project_featured_assets')

        # Removing M2M table for field featured_assets on 'Organization'
        db.delete_table('storybase_user_organization_featured_assets')
