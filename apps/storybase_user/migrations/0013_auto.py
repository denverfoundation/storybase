...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'UserProfile', fields ['profile_id']
        db.create_index('storybase_user_userprofile', ['profile_id'])

        # Adding index on 'Project', fields ['project_id']
        db.create_index('storybase_user_project', ['project_id'])

        # Adding index on 'Organization', fields ['organization_id']
        db.create_index('storybase_user_organization', ['organization_id'])


    def backwards(self, orm):
        
        # Removing index on 'Organization', fields ['organization_id']
        db.delete_index('storybase_user_organization', ['organization_id'])

        # Removing index on 'Project', fields ['project_id']
        db.delete_index('storybase_user_project', ['project_id'])

        # Removing index on 'UserProfile', fields ['profile_id']
        db.delete_index('storybase_user_userprofile', ['profile_id'])
