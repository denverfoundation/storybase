...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.notify_updates'
        db.delete_column('storybase_user_userprofile', 'notify_updates')

        # Deleting field 'UserProfile.notify_story_featured'
        db.delete_column('storybase_user_userprofile', 'notify_story_featured')

        # Adding field 'UserProfile.notify_story_unpublished'
        db.add_column('storybase_user_userprofile', 'notify_story_unpublished', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'UserProfile.notify_story_published'
        db.add_column('storybase_user_userprofile', 'notify_story_published', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'UserProfile.notify_updates'
        db.add_column('storybase_user_userprofile', 'notify_updates', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'UserProfile.notify_story_featured'
        db.add_column('storybase_user_userprofile', 'notify_story_featured', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'UserProfile.notify_story_unpublished'
        db.delete_column('storybase_user_userprofile', 'notify_story_unpublished')

        # Deleting field 'UserProfile.notify_story_published'
        db.delete_column('storybase_user_userprofile', 'notify_story_published')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 10, 3, 45, 40, 525171)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 10, 3, 45, 40, 525053)'}),
