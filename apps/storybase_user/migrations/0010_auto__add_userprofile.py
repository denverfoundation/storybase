...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('storybase_user_userprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('profile_id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, blank=True)),
            ('notify_updates', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('notify_admin', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('notify_digest', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('notify_story_featured', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('notify_story_comment', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('storybase_user', ['UserProfile'])


    def backwards(self, orm):
        
        # Deleting model 'UserProfile'
        db.delete_table('storybase_user_userprofile')
