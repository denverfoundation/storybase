...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OAuthProvider.token'
        db.add_column('storybase_user_oauthprovider', 'token', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Adding field 'OAuthProvider.secret'
        db.add_column('storybase_user_oauthprovider', 'secret', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)
