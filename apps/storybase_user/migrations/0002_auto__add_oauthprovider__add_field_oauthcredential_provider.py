...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OAuthCredential.provider'
        db.add_column('storybase_user_oauthcredential', 'provider', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='credentials', to=orm['storybase_user.OAuthProvider']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'OAuthCredential.provider'
        db.delete_column('storybase_user_oauthcredential', 'provider_id')
