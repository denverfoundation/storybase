...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OrganizationTranslation.slug'
        db.delete_column('storybase_user_organizationtranslation', 'slug')

        # Deleting field 'ProjectTranslation.slug'
        db.delete_column('storybase_user_projecttranslation', 'slug')


    def backwards(self, orm):
        
        # Adding field 'OrganizationTranslation.slug'
        db.add_column('storybase_user_organizationtranslation', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=50, db_index=True), keep_default=False)

        # Adding field 'ProjectTranslation.slug'
        db.add_column('storybase_user_projecttranslation', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=50, db_index=True), keep_default=False)
