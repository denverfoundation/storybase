...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('storybase_user_organization_users')
        ...
        db.delete_table('storybase_user_project_users')
    ...
    def backwards(self, orm):
        ...
        db.create_table('storybase_user_organization_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('organization', models.ForeignKey(orm['storybase_user.organization'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('storybase_user_organization_users', ['organization_id', 'user_id'])
        ...
        db.create_table('storybase_user_project_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm['storybase_user.project'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('storybase_user_project_users', ['project_id', 'user_id'])
    ...
    models = {
        ...
        'storybase_user.project': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'projects'", 'symmetrical': 'False', 'to': "orm['auth.User']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'db_index': 'True'})
        }
    }
