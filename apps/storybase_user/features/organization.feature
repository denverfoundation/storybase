Feature: Organizations 
    ...
    Scenario: Admin can edit the description for an Organization
        ...
        Given the admin user edits the description of the Organization to be "Mile High Connects (formerly know as the Mile High Transit Opportunity Collaborative) is an emerging collaborative of nonprofit and philanthropic organizations working together to ensure the creation of the region’s $6.7 billion FasTracks transit system benefits all communities in the region, including low-income populations."
