Feature: Projects
    ...
    Scenario: Admin can create a new Project 
        ...
        Given the user sets the "description" of the "Project" to "Test Description"
        ...
        Then the "The Metro Denver Regional Equity Atlas" Project's created on field should be set to the current date
    ...
    Scenario: An admin can edit the information for a Project
        ...
        Given the Organization "Mile High Connects" has been associated with the Project "The Metro Denver Regional Equity Atlas"
        Given the user navigates to the "Projects" admin
        ...
        Then "Mile High Connects" should be listed in the Project's Organizations list
        Then the "Regional Equity Atlas" Project's last edited field should be set to within 1 minute of the current date and time
    ...
    Scenario: An admin can create a Spanish translation to fields of a Project
        Given the admin user is logged in
        Given the Project "Regional Equity Atlas" has been created 
        Given the Project "Regional Equity Atlas" has the following description:
            """
            The Denver Regional Equity Atlas is a product of Mile High
            Connects (MHC), which came together in 2011 to ensure that 
            the region’s significant investment in new rail and bus
