...
from storybase_user.views import (OrganizationDetailView, OrganizationListView,
    OrganizationSharePopupView, OrganizationEmbedPopupView, 
    OrganizationWidgetView, ProjectDetailView,
    ProjectListView, ProjectSharePopupView, ProjectEmbedPopupView, 
    ProjectWidgetView, UserProfileDetailView, UserProfileSharePopupView,
...
urlpatterns = patterns('',
    ...
    url(r'projects/(?P<slug>[0-9a-z-]+)/share-popup/$',
        ProjectSharePopupView.as_view(), name='project_share_popup'),
    url(r'projects/(?P<organization_id>[0-9a-f]{32,32})/embed-popup/$',
