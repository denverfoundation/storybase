...
urlpatterns = patterns('',
    ...
    url(r'projects/(?P<slug>[0-9a-z-]+)/share-widget/$',
        ProjectShareWidgetView.as_view(), name='project_share_widget'),
    url(r'projects/(?P<organization_id>[0-9a-f]{32,32})/embed-widget/$',
        ProjectEmbedWidgetView.as_view(),
        name='project_embed_widget'),
    url(r'projects/(?P<slug>[0-9a-z-]+)/embed-widget/$',
        ProjectEmbedWidgetView.as_view(),
        name='project_embed_widget'),
