...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'storybase_badge.badge': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'stories': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'badges'", 'symmetrical': 'False', 'to': u"orm['storybase_story.Story']"}),
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'badges'", 'symmetrical': 'False', 'to': u"orm['storybase_user.UserProfile']"})
        },
