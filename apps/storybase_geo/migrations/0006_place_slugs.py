...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        # Empty the slug fields
        orm.Place.objects.all().update(slug='')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 21, 9, 19, 57, 634619)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 21, 9, 19, 57, 634510)'}),
