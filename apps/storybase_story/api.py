...
class StoryResource(TranslatedModelResource):
    ...
    def prepend_urls(self):
        ...
        return [
            ...
            url(r'^(?P<resource_name>{0})/templates{2}$'.format(*subs),
                self.wrap_view('dispatch_template_list'),
                name="api_dispatch_list_templates",
            ),
            url(r'^(?P<resource_name>{})/templates/(?P<template_id>{}){}$'.format(*subs),
                self.wrap_view('dispatch_template_detail'),
                name="api_dispatch_detail_templates",
            ),
            url(r'^(?P<resource_name>{})/containertemplates/templates/(?P<template_id>{}){}$'.format(*subs),
                self.wrap_view('dispatch_container_template_list'),
                name="api_dispatch_list_containertemplates",
            ),
            url(r"^(?P<resource_name>{})/(?P<story_id>{}){}$".format(*subs),
                self.wrap_view('dispatch_detail'),
                name="api_dispatch_detail",
            ),
            url(r"^(?P<resource_name>{})/(?P<story_id>{})/sections{}$".format(*subs),
                self.wrap_view('dispatch_section_list'),
                name="api_dispatch_list_sections",
            ),
            url(r"^(?P<resource_name>{0})/(?P<story_id>{1})/sections/(?P<section_id>{1}){2}$".format(*subs),
                self.wrap_view('dispatch_section_detail'),
                name="api_dispatch_detail_sections",
            ),
            url(r"^(?P<resource_name>{0})/(?P<story_id>{1})/sections/(?P<section_id>{1})/assets{2}$".format(*subs),
                self.wrap_view('dispatch_sectionasset_list'),
                name="api_dispatch_list_sectionassets",
            ),
            url(r"^(?P<resource_name>{0})/(?P<story_id>{1})/sections/(?P<section_id>{1})/assets/(?P<asset_id>{1}){2}$".format(*subs),
                self.wrap_view('dispatch_sectionasset_detail'),
                name="api_dispatch_detail_sectionassets",
            ),
            url(r"^(?P<resource_name>{})/(?P<story_id>{})/topics{}".format(*subs),
                self.wrap_view('dispatch_storycategory_list'),
                name="api_dispatch_list_storycategories"
            ),
            url(r"^(?P<resource_name>{})/(?P<story_id>{})/places{}".format(*subs),
                self.wrap_view('dispatch_storyplace_list'),
                name="api_dispatch_list_storyplaces",
            ),
            url(r"^(?P<resource_name>{})/(?P<story_id>{})/organizations{}".format(*subs),
                self.wrap_view('dispatch_storyorganization_list'),
                name="api_dispatch_list_storyorganizations",
            ),
            url(r"^(?P<resource_name>{})/(?P<story_id>{})/organizations{}".format(*subs),
                self.wrap_view('dispatch_storyorganization_list'),
                name="api_dispatch_list_storyorganizations",
            ),
            url(r"^(?P<resource_name>{})/(?P<story_id>{})/projects{}".format(*subs),
                self.wrap_view('dispatch_storyproject_list'),
                name="api_dispatch_list_storyprojects",
            ),
            url(r"^(?P<resource_name>{})/(?P<story_id>{})/related{}".format(*subs),
                self.wrap_view('dispatch_storyrelation_list'),
                name="api_dispatch_list_storyrelations",
            ),
        ]
