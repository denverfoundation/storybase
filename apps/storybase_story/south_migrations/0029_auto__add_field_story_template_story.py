...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Story.template_story'
        db.add_column('storybase_story_story', 'template_story', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='template_for', null=True, to=orm['storybase_story.Story']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Story.template_story'
        db.delete_column('storybase_story_story', 'template_story_id')
