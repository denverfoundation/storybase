...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Story.structure_type'
        db.add_column('storybase_story_story', 'structure_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Story.structure_type'
        db.delete_column('storybase_story_story', 'structure_type')
    ...
    models = {
        ...
        'storybase_story.story': {
            ...
            'structure_type': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'})
        },
