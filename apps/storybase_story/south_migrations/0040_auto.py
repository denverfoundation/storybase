...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Story', fields ['story_id']
        db.create_index('storybase_story_story', ['story_id'])

        # Adding index on 'StoryTemplate', fields ['template_id']
        db.create_index('storybase_story_storytemplate', ['template_id'])

        # Adding index on 'Section', fields ['section_id']
        db.create_index('storybase_story_section', ['section_id'])

        # Adding index on 'SectionLayout', fields ['layout_id']
        db.create_index('storybase_story_sectionlayout', ['layout_id'])


    def backwards(self, orm):
        
        # Removing index on 'SectionLayout', fields ['layout_id']
        db.delete_index('storybase_story_sectionlayout', ['layout_id'])

        # Removing index on 'Section', fields ['section_id']
        db.delete_index('storybase_story_section', ['section_id'])

        # Removing index on 'StoryTemplate', fields ['template_id']
        db.delete_index('storybase_story_storytemplate', ['template_id'])

        # Removing index on 'Story', fields ['story_id']
        db.delete_index('storybase_story_story', ['story_id'])
