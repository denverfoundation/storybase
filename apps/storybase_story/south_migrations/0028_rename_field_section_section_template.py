...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('storybase_story_section', 'section_template_id', 'template_section_id')


    def backwards(self, orm):
        db.rename_column('storybase_story_section', 'template_section_id', 'section_template_id')
