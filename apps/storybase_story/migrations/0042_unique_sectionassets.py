...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'SectionAsset', fields ['section', 'container', 'weight']
        db.create_unique('storybase_story_sectionasset', ['section_id', 'container_id', 'weight'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SectionAsset', fields ['section', 'container', 'weight']
        db.delete_unique('storybase_story_sectionasset', ['section_id', 'container_id', 'weight'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 11, 21, 28, 346916)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 11, 21, 28, 346799)'}),
