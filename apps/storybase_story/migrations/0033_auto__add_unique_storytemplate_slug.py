...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'StoryTemplate', fields ['slug']
        db.create_unique('storybase_story_storytemplate', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'StoryTemplate', fields ['slug']
        db.delete_unique('storybase_story_storytemplate', ['slug'])
