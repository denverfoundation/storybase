...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'SectionLayout', fields ['slug']
        db.create_unique('storybase_story_sectionlayout', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'SectionLayout', fields ['slug']
        db.delete_unique('storybase_story_sectionlayout', ['slug'])
