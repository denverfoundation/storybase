...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'storybase_story.story': {
            ...
            'assets': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'stories'", 'blank': 'True', 'through': "orm['storybase_story.StoryAsset']", 'to': "orm['storybase_asset.Asset']"}),
