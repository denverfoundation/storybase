...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field datasets on 'Story'
        db.create_table('storybase_story_story_datasets', (
        ...
        db.create_unique('storybase_story_story_datasets', ['story_id', 'dataset_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field datasets on 'Story'
        db.delete_table('storybase_story_story_datasets')
