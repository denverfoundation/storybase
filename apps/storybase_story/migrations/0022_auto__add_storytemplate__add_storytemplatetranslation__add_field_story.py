...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('storybase_story_storytemplate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('template_id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, blank=True)),
            ('story', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storybase_story.Story'], null=True, blank=True)),
            ('time_needed', self.gf('django.db.models.fields.CharField')(max_length=140, blank=True)),
        ))
        db.send_create_signal('storybase_story', ['StoryTemplate'])

        # Adding model 'StoryTemplateTranslation'
        db.create_table('storybase_story_storytemplatetranslation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('story_template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storybase_story.StoryTemplate'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('storybase_story_storytemplate')
