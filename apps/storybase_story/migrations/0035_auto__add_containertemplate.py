...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('storybase_story_containertemplate', (
            ...
            ('asset_type', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('can_change_asset_type', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('help', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storybase_help.Help'], null=True, blank=True)),
        ))
        db.send_create_signal('storybase_story', ['ContainerTemplate'])


    def backwards(self, orm):
        # Deleting model 'ContainerTemplate'
        db.delete_table('storybase_story_containertemplate')
