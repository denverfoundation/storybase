...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('storybase_story_story_topics', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('story', models.ForeignKey(orm['storybase_story.story'], null=False)),
            ('category', models.ForeignKey(orm['storybase_taxonomy.category'], null=False))
        ))
        db.create_unique('storybase_story_story_topics', ['story_id', 'category_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field topics on 'Story'
        db.delete_table('storybase_story_story_topics')
    ...
    models = {
        ...
        'storybase_story.story': {
            ...
            'topics': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'stories'", 'symmetrical': 'False', 'to': "orm['storybase_taxonomy.Category']"})
        },
