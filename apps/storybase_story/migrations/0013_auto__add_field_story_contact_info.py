...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Story.contact_info'
        db.add_column('storybase_story_story', 'contact_info', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Story.contact_info'
        db.delete_column('storybase_story_story', 'contact_info')
    ...
    models = {
        ...
        'storybase_story.story': {
            ...
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['storybase_user.Contact']", 'null': 'True', 'blank': 'True'}),
