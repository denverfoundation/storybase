...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StoryTranslation.slug'
        db.delete_column('storybase_story_storytranslation', 'slug')


    def backwards(self, orm):
        
        # Adding field 'StoryTranslation.slug'
        db.add_column('storybase_story_storytranslation', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=50, db_index=True), keep_default=False)
