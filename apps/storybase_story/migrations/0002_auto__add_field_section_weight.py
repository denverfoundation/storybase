...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Section.weight'
        db.add_column('storybase_story_section', 'weight', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Section.weight'
        db.delete_column('storybase_story_section', 'weight')
