...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SectionLayout.slug'
        db.add_column('storybase_story_sectionlayout', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SectionLayout.slug'
        db.delete_column('storybase_story_sectionlayout', 'slug')
