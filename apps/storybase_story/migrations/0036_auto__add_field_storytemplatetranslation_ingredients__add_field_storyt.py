...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoryTemplateTranslation.ingredients'
        db.add_column('storybase_story_storytemplatetranslation', 'ingredients',
                      self.gf('storybase.fields.ShortTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'StoryTemplateTranslation.best_for'
        db.add_column('storybase_story_storytemplatetranslation', 'best_for',
                      self.gf('storybase.fields.ShortTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'StoryTemplateTranslation.tip'
        db.add_column('storybase_story_storytemplatetranslation', 'tip',
                      self.gf('storybase.fields.ShortTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'StoryTemplate.level'
        db.add_column('storybase_story_storytemplate', 'level',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=140, blank=True),
                      keep_default=False)

        # Adding M2M table for field examples on 'StoryTemplate'
        db.create_table('storybase_story_storytemplate_examples', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('storytemplate', models.ForeignKey(orm['storybase_story.storytemplate'], null=False)),
            ('story', models.ForeignKey(orm['storybase_story.story'], null=False))
        ))
        db.create_unique('storybase_story_storytemplate_examples', ['storytemplate_id', 'story_id'])


    def backwards(self, orm):
        # Deleting field 'StoryTemplateTranslation.ingredients'
        db.delete_column('storybase_story_storytemplatetranslation', 'ingredients')

        # Deleting field 'StoryTemplateTranslation.best_for'
        db.delete_column('storybase_story_storytemplatetranslation', 'best_for')

        # Deleting field 'StoryTemplateTranslation.tip'
        db.delete_column('storybase_story_storytemplatetranslation', 'tip')

        # Deleting field 'StoryTemplate.level'
        db.delete_column('storybase_story_storytemplate', 'level')

        # Removing M2M table for field examples on 'StoryTemplate'
        db.delete_table('storybase_story_storytemplate_examples')
