...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Story.on_homepage'
        db.add_column('storybase_story_story', 'on_homepage', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Story.on_homepage'
        db.delete_column('storybase_story_story', 'on_homepage')
