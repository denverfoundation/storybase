...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Story.teaser'
        db.rename_column('storybase_story_story', 'teaser', 'summary')
        
    def backwards(self, orm):
        # Renaming field 'Story.summary'
        db.rename_column('storybase_story_story', 'summary', 'teaser')
