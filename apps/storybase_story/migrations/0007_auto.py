...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field featured_assets on 'Story'
        db.create_table('storybase_story_story_featured_assets', (
        ...
        db.create_unique('storybase_story_story_featured_assets', ['story_id', 'asset_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field featured_assets on 'Story'
        db.delete_table('storybase_story_story_featured_assets')
