...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('storybase_story_story_places', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('story', models.ForeignKey(orm['storybase_story.story'], null=False)),
            ('place', models.ForeignKey(orm['storybase_geo.place'], null=False))
        ))
        db.create_unique('storybase_story_story_places', ['story_id', 'place_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field places on 'Story'
        db.delete_table('storybase_story_story_places')
