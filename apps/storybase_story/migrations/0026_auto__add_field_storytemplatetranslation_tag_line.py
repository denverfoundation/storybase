...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StoryTemplateTranslation.tag_line'
        db.add_column('storybase_story_storytemplatetranslation', 'tag_line', self.gf('storybase.fields.ShortTextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StoryTemplateTranslation.tag_line'
        db.delete_column('storybase_story_storytemplatetranslation', 'tag_line')
