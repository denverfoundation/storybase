...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Section.section_template'
        db.add_column('storybase_story_section', 'section_template', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='template_for', null=True, to=orm['storybase_story.Section']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Section.section_template'
        db.delete_column('storybase_story_section', 'section_template_id')
    ...
    models = {
        ...
        'storybase_story.section': {
            ...
            'section_template': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'template_for'", 'null': 'True', 'to': "orm['storybase_story.Section']"}),
