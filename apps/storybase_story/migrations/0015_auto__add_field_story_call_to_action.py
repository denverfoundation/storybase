...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Story.call_to_action'
        db.add_column('storybase_story_story', 'call_to_action', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Story.call_to_action'
        db.delete_column('storybase_story_story', 'call_to_action')
