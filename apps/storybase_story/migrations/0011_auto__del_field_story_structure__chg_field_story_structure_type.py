...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Story.structure'
        db.delete_column('storybase_story_story', 'structure')

        # Changing field 'Story.structure_type'
        db.alter_column('storybase_story_story', 'structure_type', self.gf('django.db.models.fields.CharField')(default='', max_length=20))


    def backwards(self, orm):
        
        # Adding field 'Story.structure'
        db.add_column('storybase_story_story', 'structure', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Changing field 'Story.structure_type'
        db.alter_column('storybase_story_story', 'structure_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
