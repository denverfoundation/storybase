...
def homepage_intro_list(num_stories):
    """Render a listing of stories for the homepage 'intro' """
    ...
    for i in range(num_stories):
        ...
        if (image_num > 9):
            image_num -= 9
        stories.append({"image": "image%d.jpg" % image_num, "title": "intro story %d title here." % i})
    return stories
