...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HelpPlugin'
        db.create_table('cmsplugin_helpplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('help', self.gf('django.db.models.fields.related.ForeignKey')(related_name='plugins', to=orm['storybase_help.Help'])),
        ))
        db.send_create_signal('cmsplugin_storybase', ['HelpPlugin'])


    def backwards(self, orm):
        
        # Deleting model 'HelpPlugin'
        db.delete_table('cmsplugin_helpplugin')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 23, 18, 8, 16, 626961)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 23, 18, 8, 16, 626826)'}),
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 23, 18, 8, 16, 618754)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
