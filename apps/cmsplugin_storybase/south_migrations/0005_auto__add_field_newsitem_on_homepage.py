...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NewsItem.on_homepage'
        db.add_column('cmsplugin_storybase_newsitem', 'on_homepage', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NewsItem.on_homepage'
        db.delete_column('cmsplugin_storybase_newsitem', 'on_homepage')
