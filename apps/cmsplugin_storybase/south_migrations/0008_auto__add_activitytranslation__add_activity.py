...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActivityTranslation'
        db.create_table('cmsplugin_storybase_activitytranslation', (
            ...
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cmsplugin_storybase.Activity'])),
            ('title', self.gf('storybase.fields.ShortTextField')()),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('supplies', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('time', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('num_participants', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('links', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('cmsplugin_storybase', ['ActivityTranslation'])

        # Adding model 'Activity'
        db.create_table('cmsplugin_storybase_activity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, blank=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.Page'], unique=True, null=True, blank=True)),
        ))
        db.send_create_signal('cmsplugin_storybase', ['Activity'])

        # Adding model 'ActivityPlugin'
        db.create_table('cmsplugin_activityplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='plugins', to=orm['cmsplugin_storybase.Activity'])),
        ))
        db.send_create_signal('cmsplugin_storybase', ['ActivityPlugin'])


    def backwards(self, orm):
        # Deleting model 'ActivityTranslation'
        db.delete_table('cmsplugin_storybase_activitytranslation')

        # Deleting model 'Activity'
        db.delete_table('cmsplugin_storybase_activity')

        # Deleting model 'ActivityPlugin'
        db.delete_table('cmsplugin_activityplugin')
    ...
    models = {
        ...
        'cmsplugin_storybase.activity': {
            'Meta': {'object_name': 'Activity'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.Image']", 'null': 'True', 'blank': 'True'}),
            'page': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.Page']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'blank': 'True'})
        },
        'cmsplugin_storybase.activityplugin': {
            'Meta': {'object_name': 'ActivityPlugin', 'db_table': "'cmsplugin_activityplugin'", '_ormbases': ['cms.CMSPlugin']},
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'plugins'", 'to': "orm['cmsplugin_storybase.Activity']"}),
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'})
        },
        'cmsplugin_storybase.activitytranslation': {
            'Meta': {'object_name': 'ActivityTranslation'},
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cmsplugin_storybase.Activity']"}),
            ...
            'num_participants': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'supplies': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'time': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'title': ('storybase.fields.ShortTextField', [], {}),
            'translation_id': ('uuidfield.fields.UUIDField', [], {'unique': 'True', 'max_length': '32', 'blank': 'True'})
        },
        'cmsplugin_storybase.helpplugin': {
            'Meta': {'object_name': 'HelpPlugin', 'db_table': "'cmsplugin_helpplugin'", '_ormbases': ['cms.CMSPlugin']},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'help': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'plugins'", 'to': "orm['storybase_help.Help']"})
        },
        ...
        'cmsplugin_storybase.teaser': {
            'Meta': {'unique_together': "(('language', 'page'),)", 'object_name': 'Teaser'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            'page': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'teaser_set'", 'to': "orm['cms.Page']"}),
        ...
        'storybase_taxonomy.taggeditem': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'storybase_taxonomy_taggeditem_tagged_items'", 'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
