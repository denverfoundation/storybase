...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Teaser'
        db.create_table('cmsplugin_storybase_teaser', (
            ...
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='teaser_set', to=orm['cms.Page'])),
        ))
        db.send_create_signal('cmsplugin_storybase', ['Teaser'])

        # Adding unique constraint on 'Teaser', fields ['language', 'page']
        db.create_unique('cmsplugin_storybase_teaser', ['language', 'page_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Teaser', fields ['language', 'page']
        db.delete_unique('cmsplugin_storybase_teaser', ['language', 'page_id'])

        # Deleting model 'Teaser'
        db.delete_table('cmsplugin_storybase_teaser')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 21, 16, 49, 24, 628641)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 21, 16, 49, 24, 628529)'}),
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 21, 16, 49, 24, 604940)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
