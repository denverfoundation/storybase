...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'StoryPlugin'
        db.create_table('cmsplugin_storyplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('story', self.gf('django.db.models.fields.related.ForeignKey')(related_name='plugins', to=orm['storybase_story.Story'])),
        ))
        db.send_create_signal('cmsplugin_storybase', ['StoryPlugin'])


    def backwards(self, orm):
        
        # Deleting model 'StoryPlugin'
        db.delete_table('cmsplugin_storyplugin')
    ...
    models = {
        ...
        'storybase_story.story': {
            ...
            'assets': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'stories'", 'symmetrical': 'False', 'to': "orm['storybase_asset.Asset']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
