...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'List'
        db.create_table('cmsplugin_list', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('num_items', self.gf('django.db.models.fields.IntegerField')(default=3)),
        ))
        db.send_create_signal('cmsplugin_storybase', ['List'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'List'
        db.delete_table('cmsplugin_list')
