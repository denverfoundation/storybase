...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_index('storybase_asset_asset', ['asset_id'])

        # Adding index on 'DataSet', fields ['dataset_id']
        db.create_index('storybase_asset_dataset', ['dataset_id'])


    def backwards(self, orm):
        
        # Removing index on 'DataSet', fields ['dataset_id']
        db.delete_index('storybase_asset_dataset', ['dataset_id'])

        # Removing index on 'Asset', fields ['asset_id']
        db.delete_index('storybase_asset_asset', ['asset_id'])
