...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataSet.links_to_file'
        db.add_column('storybase_asset_dataset', 'links_to_file', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DataSet.links_to_file'
        db.delete_column('storybase_asset_dataset', 'links_to_file')
