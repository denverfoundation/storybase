...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('storybase_asset_localdataset', 'file_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'LocalDataSet.file'
        raise RuntimeError("Cannot reverse this migration. 'LocalDataSet.file' and its values cannot be restored.")
