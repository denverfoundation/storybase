...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LocalImageAssetTranslation.image'
        db.alter_column('storybase_asset_localimageassettranslation', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'LocalImageAssetTranslation.image'
        raise RuntimeError("Cannot reverse this migration. 'LocalImageAssetTranslation.image' and its values cannot be restored.")
